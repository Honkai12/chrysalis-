...
public class ShatteredSanguineDormantCurio extends CurioBaseItem {
    public ShatteredSanguineDormantCurio() {
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> getAttributeModifiers(SlotContext slotContext, ResourceLocation id, ItemStack stack) {
        ...
        attr.put(AttributeRegistry.ICE_SPELL_POWER, new AttributeModifier(id, 0.05, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        return attr;
    }
}